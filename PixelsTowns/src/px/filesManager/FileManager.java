...
public class FileManager {
	//Classe pour gérer la lecture et la sauvegarde des fichiers
	...
	public static String path = "Dudullle/towny/"; // -> /towns -> fichiers des villes -> /players -> dossier des joueurs -> /config -> Données IMPORTANTES
