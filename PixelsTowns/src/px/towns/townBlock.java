...
public class townBlock {
	public int xCoord = 0; //Coordonées en X (ATTENTION carrés de 16*16)
	public int yCoord = 0; //Coordonées en Y
	...
	public boolean broken = false; //Indique si le bloc est endomagé ou pas
